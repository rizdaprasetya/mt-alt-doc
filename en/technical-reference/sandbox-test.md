...
Payment category:
- [Credit Card](/en/technical-reference/sandbox-test?id=credit-card)
- [E-Wallet](/en/technical-reference/sandbox-test?id=e-wallet)
- [Bank Transfer](/en/technical-reference/sandbox-test?id=bank-transfer)
- [Direct Debit](/en/technical-reference/sandbox-test?id=direct-debit)
- [Convenience Store](/en/technical-reference/sandbox-test?id=convenience-store)
- [Cardless Credit](/en/technical-reference/sandbox-test?id=cardless-credit)
...
|----------|------------|
|Go-Pay | On mobile platform you will be auto redirected to Gopay Simulator. <br> On desktop, QR Code image will be displayed, copy the QR Code image URL then use this [Gopay Simulator](https://simulator.sandbox.midtrans.com/gopay/ui/index).|
