...
| challenge_completion     | Whether the 3DS 2 challenge input was completed by customer.| Boolean | Example values `true` or `false`. Field may not exist if 3DS 2  challenge input was not prompted.|
